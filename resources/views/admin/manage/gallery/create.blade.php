        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <form id="formGallery" method="post" enctype="multipart/form-data" class="custom-validation"
                      @if(isset($galleries)) data-action="{{route('gallery.update',$galleries->id)}}" data-type="update"
                      @else data-action="{{route('gallery.store')}}" data-type="store" @endif>
                    @csrf
                    <div class="row">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input value="{{ isset($galleries) ? $galleries->title:'' }}" id="title"
                                               name="title"
                                               type="text"
                                                    ...
                                                    <div class="card">
                                                        <div class="card-body">
                                                            ...
                                                            <div>
                                                                <div class="dropzone">
                                                                    <div class="dz-message needsclick">
                                                                        @if(!@$galleries->img_src)
                                                                            <div class="mb-3 iconImageIndex">
                                                                                <i class="display-4 text-muted bx bxs-cloud-upload"></i>
                                                                            </div>
                                                                        @endif
                                                                        <div id="my_image">
                                                                            @if(@$galleries->img_src) @foreach(explode(',',$galleries->img_src) as $img)
                                                            ...
                                                            <div class="text-center mt-4">
                                                                <div id="elfinder"></div>
                                                                <input value="{{@$galleries->img_src}}" name="img_src"
                                                                       class="form-control"
