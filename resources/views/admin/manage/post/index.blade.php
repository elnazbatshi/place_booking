                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">مدیریت پست ها</h4>

                            <div class="page-title-left">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">پنل</a></li>
                                    <li class="breadcrumb-item active">مدیریت پست</li>
                                </ol>

                                @can('create',\App\Models\Post::class)
                                    <a href="{{route('post.create')}}">
                                        <button class="btn btn-success">اضافه کردن پست
                                        </button>
                                    </a>
                                @endcan
                            </div>
                                    ...
                                    <table class="table align-middle table-nowrap table-hover">
                                        ...
                                        @foreach($posts as $post)
                                            ...
                                            <tr id="post_{{$post->id}}">
                                                ...
                                                <td>
                                                    <select onchange="changeStatusPost(this)"
                                                            data-action="{{route('post.changeStatusPost',$post->id)}}"
                                                            id="statusPost" name="status" data-toggle="tooltip"
                                                            data-placement="top"
                                                        ...
                                                        {{--                                                        <option  @if(isset($post)) {{($post->status ==\App\Models\Post::STATUS_CHOICE_ADMIN) ?'selected=selected':" "}}@endif  value="{{\App\Models\Post::STATUS_CHOICE_ADMIN}}">انتخاب سردبیر</option>--}}
                                                    </select>
                                                </td>
                                                ...
                                                <td>
                                                    @can('update',\App\Models\Post::class)
                                                        <a href="{{route('post.edit',$post->id)}}">
                                                            <button type="button" class="btn btn-primary"
                                                                    ...
                                                                    data-action="{{route('post.edit',$post->id)}}">
                                                    ...
                                                    @can('delete',\App\Models\Post::class)
                                                        <button type="button" class="btn btn-danger"
                                                                data-toggle="tooltip"
                                                                data-title="حذف منو"
                                                                data-action="{{route('post.destroy',$post->id)}}"
