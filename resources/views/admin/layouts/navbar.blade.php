        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                ...
                <a href="/" class="logo logo-light">
                                <span class="logo-sm">
                                    <img src="{{asset('assets/images/logo/logo-222-site-hoze-honari.png')}}" alt=""
                                         height="22">
                                </span>
                    <span class="logo-lg">
                                    <img src="{{asset('assets/images/logo/logo-222-site-hoze-honari.png')}}" alt=""
...
{{--                </button>--}}
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                        data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="rounded-circle header-profile-user" src="{{asset('assetsSite/img/profile-man.svg')}}"
                         alt="Header Avatar">
