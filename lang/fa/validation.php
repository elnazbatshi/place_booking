...
return [
    ...
    'attributes'           => [
        ...
        'eduField'               => 'رشته تحصیلی',
        'bio'                    => 'بیوگرافی',
        'categories'             => 'دسته بندی ها',
        'data'                   => 'دسته بندی',
        'data.*.cost*'           => 'هزینه',
        'data.*.discount*'       => 'تخفیف',
        'data.*.discountedCost*' => 'قیمت نهایی',
        'data.*.commission*'     => 'کمیسیون',
        'data.*.medicalNumber'   => 'شماره نظام پزشکی',

        'data.*.bankName_*'   => 'نام بانک',
        'data.*.shaba_*'      => 'شماره شبا',
        'data.*.account_*'    => 'شماره حساب',
        'data.*.cardNumber_*' => 'شماره کارت',
        'data.*.is_default_*' => 'حساب پیشفرض',

        'courseName'       => 'نام دوره',
        'courseCost'       => 'مبلغ دوره',
        'discount'         => 'تخفیف',
        'commission'       => 'کمیسیون',
        'banner'           => 'بنر',
        'video'            => 'ویدیو',
