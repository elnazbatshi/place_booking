                                ...
                                <div class="table-responsive">
                                    <table class="table align-middle table-nowrap table-hover">
                                        ...
                                        <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <tr id="location_<?php echo e($post->id); ?>">
                                                <td>
                                                    <?php echo e($post->id); ?>
                                                ...
                                                <td>
                                                        <span class="badge bg-success font-size-large">
                                                               <?php echo e($post->categories->title); ?>
                                                ...
                                                <td>
                                                    <select style="width: 85px"
                                                            ...
                                                            data-action="<?php echo e(route('location.changeStatus',$post->id)); ?>"
                                                            name="status" data-toggle="tooltip" data-placement="top"

                                                            class="form-select statusPost">
                                                        <option
                                                            <?php if(isset($post)): ?> <?php echo e(($post->status ==\App\Models\LocationInfo::STATUS_ACTIVE) ?'selected=selected':" "); ?><?php endif; ?>  value="<?php echo e(\App\Models\LocationInfo::STATUS_ACTIVE); ?>">
                                                            فعال
                                                        </option>
                                                        <option
                                                            <?php if(isset($post)): ?> <?php echo e(($post->status ==\App\Models\LocationInfo::STATUS_DEACTIVATE) ?'selected=selected':" "); ?><?php endif; ?>  value="<?php echo e(\App\Models\LocationInfo::STATUS_DEACTIVATE); ?>">
                                                            غیر فعال
                                                        </option>
                                                    </select>
                                                </td>
                                                ...
                                                <td>
                                                    <a>
                                                        <a href="<?php echo e(route('location.edit',$post->id)); ?>">
                                                    ...
                                                    <button type="button" class="btn btn-danger"
                                                            data-toggle="tooltip"
                                                            data-title="حذف منو"
                                                            data-action="<?php echo e(route('location.destroy',$post->id)); ?>"
                                                    ...
                                                    <button type="button" class="btn btn-warning"
                                                            ...
                                                            data-action="<?php echo e(route('location.show',$post->id)); ?>">
                                                        <i class="fa fa-eye"></i>
                                                    </button>
                        ...
                        <div class="col-12">
                            ...
                            <div class=" mb-4">
                                <img class="mx-2" style="height: 100px"
                                     src="<?php echo e(asset('assets/images/profile-img.png')); ?>">
                                <img class="mx-2" style="height: 100px"
                                     src="<?php echo e(asset('assets/images/small/img-1.jpg')); ?>">
                            </div>
                        </div>
                        <hr>
                        <div class="col-12">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH I:\Projects\booking2\resources\views/admin/manage/location/index.blade.php ENDPATH**/ ?>