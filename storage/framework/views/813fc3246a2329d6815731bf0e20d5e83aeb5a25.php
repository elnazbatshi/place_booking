                                            ...
                                            <tr id="user_<?php echo e($user->id); ?>">
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-primary"
                                                            ...
                                                            data-action="<?php echo e(route('customer.update',$user->id)); ?>"
                                                    ...
                                                    <button type="button" class="btn btn-danger"
                                                            data-toggle="tooltip"
                                                            data-title="حذف منو"
                                                            data-action="<?php echo e(route('customer.destroy',$user->id)); ?>"
                ...
                <div class="modal-footer">
                    ...
                    <div>
                        <button data-update-role onclick="addCustomer(this)"
                                data-action="<?php echo e(route('customer.store')); ?>" type="button"
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH I:\Projects\booking2\resources\views/admin/manage/customer/index.blade.php ENDPATH**/ ?>