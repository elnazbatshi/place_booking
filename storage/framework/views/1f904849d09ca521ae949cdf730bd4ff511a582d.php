        ...
        <?php if(isset($route)): ?>
            ...
            <div class="login-col">
                ...
                <div class="login-form">
                    ...
                    <input type="text" name="personal_id" id="personal_id" placeholder="شماره پرسنلی خود را وارد کنید">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="checkbox-login pull-right">
                    <input class="remember" name="remember" type="checkbox" id="remember" value="accept_rules">
...
<?php /**PATH I:\Projects\booking2\resources\views/booking/auth/login.blade.php ENDPATH**/ ?>