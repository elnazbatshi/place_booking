                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        <form method="post" data-type="social" class="addSettingForm"
                              action="<?php echo e(route('admin.storeSetting')); ?>">
                        ...
                        <div class="container-fluid">
                            <table class="table table-bordered dt-responsive  nowrap w-100">
                                ...
                                <?php echo $__env->make('admin.manage.setting.ajax.table-social', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                </tbody>
                            </table>
                        </div>
                    </div>
                    <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                        <div>
                            <form method="post" data-type="info" id="addInfoForm"
                                  action="<?php echo e(route('admin.storeInfo')); ?>" class=" form-contact ">
                                <?php echo csrf_field(); ?>
                                <div class="form-row pt-4">
                                    <div class="form-group col-lg-6 col-md-6">
                                        <label for="email">ایمیل</label>
                                        <input value="<?php echo e(isset($info) ? $info->email:''); ?>" name="email" type="email"
                                ...
                                <div class="form-row">
                                    <div class="form-group col-lg-6 col-md-6">
                                        ...
                                        <input value="<?php echo e(isset($info) ? $info->phoneNumber:''); ?>" name="phoneNumber"
                                               type="text" class="form-control" id="phoneNumber">
                                    </div>
                                    <div class="form-group col-lg-6 col-md-6">
                                        <label for="address"> آدرس</label>
                                        <input <?php echo e(isset($info) ? $info->address:''); ?> name="address" type="text"
                                    ...
                                    <div class="form-group col-lg-6 col-md-6">
                                        ...
                                        <div id="aboutContent">
                                            <?php echo isset($info) ? $info->description:''; ?>

                                        </div>
                                        <img style="height: 100px;" class="my-3" id="my_image"
                                             src="<?php echo isset($info) ? $info->image:'booking/images/upload-icon-15.png'; ?>"
                                             alt="">
                                    </div>
                                    ...
                                    <div class="form-group col-lg-6 col-md-6">
                                        ...
                                        <input value=" <?php echo isset($info) ? $info->image:''; ?>" name="image"
                                               class="form-control"
                        ...
                        <div class="container-fluid">
                            <table class="table table-bordered dt-responsive  nowrap w-100">
                                ...
                                <tbody id="info-table">
                                <?php echo $__env->make('admin.manage.setting.ajax.table-info', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                </tbody>
                            </table>
                        </div>
                    </div>
            ...
            <div class="modal-footer">
                ...
                <div>
                    <button data-update-social onclick="updateSocial(this)"
                            data-action="<?php echo e(route('admin.updateSocial')); ?>" type="button"
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH I:\Projects\booking2\resources\views/admin/manage/setting/index.blade.php ENDPATH**/ ?>