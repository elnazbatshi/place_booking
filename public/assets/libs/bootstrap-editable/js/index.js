/*! X-editable - v1.5.1
* In-location editing with Twitter Bootstrap, jQuery UI or pure jQuery
    ...
    $.fn.editableutils = {
       ...
       */
        createInput: function (options) {
            ...
            //depending on mode and core libs
            if (type === 'date') {
                //inline
        ...
        renderForm: function () {
            this.$form
                ...
                .on({
                    ...
                    rendering: $.proxy(this.setPosition, this), //this allows to location container correctly when loading shown
