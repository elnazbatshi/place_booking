...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        jQuery('.slider-site').owlCarousel({
            slideSpeed: 500,
            rtl: true,
            autoplay: false,
            autoplaySpeed: 3000,
            ...
            items: 1,
            lazyLoad: true,
            navText: ["<i class='icon-Vector-3'></i>", "<i class='icon-Vector-4'></i>"],
            responsive: {
                450: {
                    margin: 30,
                },
        ...
        jQuery(".header-search").click(function (e) {
            e.preventDefault();
            $(".search-pup-up").fadeIn(500);
            $(".search-pup-up").addClass('popup-search-active');
        });
